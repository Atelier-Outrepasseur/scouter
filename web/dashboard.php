...
<body>
    ...
    $reportPages = ['home', 'categories', 'codes', 'response-time', 'depth', 'redirect-chains', 'inlinks', 'outlinks', 'pagerank', 'seo-tags', 'headings', 'duplication', 'extractions', 'structured-data', 'search-console', 'images', 'hreflang', 'opengraph', 'pagespeed', 'seo-score', 'export', 'sitemap'];
        ...
        <main class="main-content">
            ...
            switch($page) {
                ...
                case 'opengraph':
                    ...
                    break;
                case 'pagespeed':
                    include 'pages/pagespeed.php';
                    break;
                case 'seo-score':
                    include 'pages/seo-score.php';
                    break;
                case 'sitemap':
